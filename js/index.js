API_KEY = "API_KEY=4e9f68c76b4e3d7a8b5f1c2d3e4f5a6b";
...
addLivre = () => {
    const newProduct = {
        ...
        autheur: localStorage.getItem("autheur"),
        isbn: localStorage.getItem("isbn"),
        datePub: localStorage.getItem("datePub"),
        disponibilite: localStorage.getItem("disponibilite")
    }
    ...
    const url = API + 'livre?' + params + API_KEY;
